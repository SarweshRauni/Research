...
# MCA:
    ...
    # Extracts factors that explain the most variance in the data.
...
# Data Preparation:
    # Transposes the combined_components to match the input format expected by the clustering function.
# Parameters:
...
# Filtering Data:
    # Ensures that only patients included in cluster_pivot are in data_all_years.
# Assigning States:
...
# Visualization:
    ...
    # annot=True: Displays the probability values on the heatmap.
